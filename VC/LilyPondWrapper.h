...
public:
	...
	void Initialize(CString LilyPondPath, CString TempPath, NarratedMusicSheet * pSheet, CString FilePath);
	...
	bool GetMeasureImage(int iMovementNo, int iMeasureNo, CImage & Image, bool bForceRecheck=false);
